<template>
    <div class="copyToClipboard" :class="{ 'copyToClipboard--alignRight': this.align == 'right'}">
        <a href="#" @click.prevent="copyToClipboard($event)" class="titleBlock__button button button--icon">
            <span class="button__text">{{ this.buttonTitle }}</span>
